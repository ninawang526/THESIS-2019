...
if __name__ == '__main__':
	...
	arts, dictionary, corpus, model = lex.LDA(articles, LEFT_WORDS+RIGHT_WORDS,num_topics=30,load=False)

	# SAVE
	with open("all_model2012.pkl","wb") as f:
		pickle.dump(model, f)
	with open("all_articles2012.pkl","wb") as f:
		pickle.dump(arts, f)
	with open("all_dictionary2012.pkl","wb") as f:
		pickle.dump(dictionary, f)
	with open("all_corpus2012.pkl","wb") as f:
